...
('P005', 'Healthy (Daun Sehat & Normal)', 'Oryza sativa', 'Kondisi daun padi berada dalam keadaan normal dan sehat. Tidak ditemukan gejala infeksi jamur, bakteri, maupun virus.', 'Tetap lakukan pemantauan berkala dan pertahankan pemupukan yang berimbang.', 'Pertahankan sanitasi lahan, sistem irigasi yang baik, dan gunakan varietas benih unggul.');
