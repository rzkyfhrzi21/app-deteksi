                            ...
                            <div class="dropdown">
                                <a href="#" id="topbarUser Dropdown" class="user-dropdown d-flex align-items-center dropend dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="text">
                                        ...
                                        <p class="user-dropdown-status text-sm text-muted text-capitalize">Deteksi</p>
                                    </div>
                                </a>
                        ...
                        <ul>
                            ...
                            <li class="menu-item has-sub">
                                <a href="#" class='menu-link'>
                                    <span><i class="select-all fas"></i> Users</span>
                                </a>
                                <div class="submenu">
                                    <div class="submenu-group-wrapper">
                                        <ul class="submenu-group">
                                            ...
                                            <li class="submenu-item">
                                                <a href="?page=data user" class='submenu-link'>Data User</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <li class="menu-item has-sub">
                                <a href="#" class='menu-link'>
                                    <span class="fa-fw select-all fas"></span> Sistem Deteksi
                                </a>
                                <div class="submenu">
                                    <div class="submenu-group-wrapper">
                                        <ul class="submenu-group">
                    ...
                    <div class="footer clearfix mb-0 text-muted">
                        ...
                        <div class="float-end">
                            <p>Dibuat dengan <span class="text-danger"><i class="bi bi-heart"></i></span>
                                oleh <a href="https://www.instagram.com/lulukaulani/" target="_blank">Luluk Aulani</a></p>
                        </div>
                    </div>
                </div>
            </footer>
